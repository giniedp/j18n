(function(){
  ...
  I18n.addValue = function(key, value){
    var path = key.split(".");
  ...
  I18n.makeKey = function(locale, scope, key){
    var result = [];
  ...
  I18n.interpolate = function(str, key, value){
  ...
  I18n.performTranslation = function(locale, scope, key, defaultValue, interpolation){
